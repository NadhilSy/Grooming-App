...
public class SystemAuthServiceImpl implements SystemAuthService {
    ...
    public User register(RegistrationRequest registrationRequest) {
        try {
            ...
            user.setPhoto("https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=387&q=80");
